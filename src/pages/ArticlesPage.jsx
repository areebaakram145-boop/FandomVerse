  ...
  return (
    <div className="articles-page-view">
      ...
      <div className="filter-sort-bar">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.05)', padding: '0.35rem 0.75rem', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
      ...
      {filteredArticles.length === 0 ? (
        <div style={{ padding: '4rem 2rem', textAlign: 'center', background: 'var(--bg-card)', borderRadius: '12px' }}>
          <p style={{ color: '#94a3b8', fontSize: '1.1rem' }}>No articles match your search criteria.</p>
        </div>
      ) : (
            ...
            return (
              <article key={art.id} className="content-card">
                ...
                <div className="card-body">
                  ...
                  <div style={{ fontSize: '0.82rem', color: '#818cf8', marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '4px' }}>
                    <User size={12} />
